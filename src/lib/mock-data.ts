...
export let players: Player[] = [
    { id: 'p-001', name: 'Lionel Messi', photoUrl: 'https://placehold.co/400x400.png', team: 'Cosmic Comets', teamId: '1', category: 'Máxima', position: 'Delantero', stats: { goals: 22, assists: 10, yellowCards: 3, redCards: 0 }, idNumber: '1712345678', birthDate: '1987-06-24', jerseyNumber: 10 },
    { id: 'p-002', name: 'Cristiano Ronaldo', photoUrl: 'https://placehold.co/400x400.png', team: 'Cosmic Comets', teamId: '1', category: 'Máxima', position: 'Delantero', stats: { goals: 25, assists: 5, yellowCards: 4, redCards: 0 }, idNumber: '1712345679', birthDate: '1985-02-05', jerseyNumber: 7 },
    { id: 'p-003', name: 'Neymar Jr', photoUrl: 'https://placehold.co/400x400.png', team: 'Cosmic Comets', teamId: '1', category: 'Máxima', position: 'Delantero', stats: { goals: 18, assists: 15, yellowCards: 6, redCards: 1 }, idNumber: '1712345680', birthDate: '1992-02-05', jerseyNumber: 11 },
    { id: 'p-004', name: 'Kylian Mbappé', photoUrl: 'https://placehold.co/400x400.png', team: 'Solar Flares', teamId: '2', category: 'Máxima', position: 'Delantero', stats: { goals: 28, assists: 8, yellowCards: 2, redCards: 0 }, idNumber: '1712345681', birthDate: '1998-12-20', jerseyNumber: 7 },
    { id: 'p-005', name: 'Kevin De Bruyne', photoUrl: 'https://placehold.co/400x400.png', team: 'Solar Flares', teamId: '2', category: 'Máxima', position: 'Mediocampista', stats: { goals: 12, assists: 25, yellowCards: 3, redCards: 0 }, idNumber: '1712345682', birthDate: '1991-06-28', jerseyNumber: 17 },
    { id: 'p-006', name: 'Virgil van Dijk', photoUrl: 'https://placehold.co/400x400.png', team: 'Galaxy Gliders', teamId: '3', category: 'Máxima', position: 'Defensa', stats: { goals: 5, assists: 3, yellowCards: 1, redCards: 0 }, idNumber: '1712345683', birthDate: '1991-07-08', jerseyNumber: 4 },
    { id: 'p-007', name: 'Luka Modric', photoUrl: 'https://placehold.co/400x400.png', team: 'Orion Stars', teamId: '4', category: 'Máxima', position: 'Mediocampista', stats: { goals: 8, assists: 18, yellowCards: 2, redCards: 0 }, idNumber: '1712345684', birthDate: '1985-09-09', jerseyNumber: 10 },
    { id: 'p-008', name: 'Erling Haaland', photoUrl: 'https://placehold.co/400x400.png', team: 'Vortex Voyagers', teamId: '5', category: 'Primera', position: 'Delantero', stats: { goals: 35, assists: 5, yellowCards: 1, redCards: 0 }, idNumber: '1712345685', birthDate: '2000-07-21', jerseyNumber: 9 },
    { id: 'p-009', name: 'Mohamed Salah', photoUrl: 'https://placehold.co/400x400.png', team: 'Pulsar Pioneers', teamId: '6', category: 'Primera', position: 'Delantero', stats: { goals: 25, assists: 12, yellowCards: 0, redCards: 0 }, idNumber: '1712345686', birthDate: '1992-06-15', jerseyNumber: 11 },
    { id: 'p-010', name: 'Alisson Becker', photoUrl: 'https://placehold.co/400x400.png', team: 'Quasar Quest', teamId: '7', category: 'Copa', position: 'Portero', stats: { goals: 0, assists: 1, yellowCards: 1, redCards: 0 }, idNumber: '1712345687', birthDate: '1992-10-02', jerseyNumber: 1 },
];
